...
func (projectL) LoadOwner(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProject interface{}, mods queries.Applicator) error {
	var slice []*Project
	var object *Project
...
func (o *Project) SetOwner(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
...
func (o *Project) RemoveOwner(ctx context.Context, exec boil.ContextExecutor, related *User) error {
	var err error
	...
	for i, ri := range related.R.OwnerProjects {
		if queries.Equal(o.OwnerID, ri.OwnerID) {
			continue
		}

		ln := len(related.R.OwnerProjects)
		if ln > 1 && i < ln-1 {
			related.R.OwnerProjects[i] = related.R.OwnerProjects[ln-1]
		}
		related.R.OwnerProjects = related.R.OwnerProjects[:ln-1]
		break
	}
	return nil
}
